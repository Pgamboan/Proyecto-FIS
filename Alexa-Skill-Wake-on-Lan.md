...
Para verificar la calidad y que el proyecto cumpliera nuestras expectativas, al realizar tareas, se comprobaba que todos los integrantes del equipo estuvieramos
de acuerdo con el resultado, si había errores, corregirlos durante las reuniones para llegar a un comun acuerdo. Al mismo que estar todos ayudando y contribuyendo 
en las diferentes partes del proyecto con aportando todo el conocimiento posible para que quedara lo más completo posible.

Durante la realización de las actividades y al final el integrante Diego Alamilla Osorio, fue el encargado de revisar y corregir errores de 
